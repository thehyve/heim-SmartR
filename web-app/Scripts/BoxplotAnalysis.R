...
SmartR.output$cohort1 <- calc_boxplot(data.cohort1$concept1, data.cohort1$subsets1)

if (length(data.cohort2$concept2) > 0) {
	SmartR.output$cohort2 <- calc_boxplot(data.cohort2$concept2, data.cohort2$subsets2)
}
